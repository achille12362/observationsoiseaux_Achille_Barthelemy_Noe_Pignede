...
jsonSource_nom_oiseaux_alain_andre_3.addFeatures(features_nom_oiseaux_alain_andre_3);cluster_nom_oiseaux_alain_andre_3 = new ol.source.Cluster({
  distance: 10,
  source: jsonSource_nom_oiseaux_alain_andre_3
});
var lyr_nom_oiseaux_alain_andre_3 = new ol.layer.Vector({
                declutter: true,
                source:cluster_nom_oiseaux_alain_andre_3, 
...
lyr_nom_oiseaux_alain_andre_3.set('fieldAliases', {'nom': 'nom', 'nombre': 'nombre', 'contact': 'contact', 'certitude': 'certitude', });
...
lyr_nom_oiseaux_alain_andre_3.set('fieldImages', {'nom': 'TextEdit', 'nombre': 'Range', 'contact': 'ValueMap', 'certitude': 'ValueMap', });
...
lyr_nom_oiseaux_alain_andre_3.set('fieldLabels', {'nom': 'header label', 'nombre': 'header label', 'contact': 'header label', 'certitude': 'header label', });
